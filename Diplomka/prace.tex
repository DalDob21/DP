...
\nastavabstraktcz{Cílem diplomové práce je analyzovat, doplnit a rozšířit stavajici dispečinkový system o nové zdroje dat zpoždění a polohy spojů. To bude zahrnovat připojení na SOAPové api společnosti SŽDC odkud budem načítat aktualní zpoždění a další doplňkové informace. Pro účeli návrhu výpočtu zpoždění a polohy vozů se bude potřeba připojít k RESTovému api Polohavozu.cz . Jako poslední pak bude potřeba načítat strukturu vlakového spoje pomocí JavaMail api, to vše se bude ukládat do databaze stavajícího dispečinkovehé systému.}
