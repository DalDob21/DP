...
\obr{audit zpoždění}{fig:auditDelay}{0.4}{graphics/auditDelay.png}

\n{2}{Stanovení cílů (popis cílového stavu)}
\begin{itemize}
	\setlength{\parskip}{0pt}
	\setlength{\itemsep}{0pt}
	\setstretch{1.05}
	\item Automatizovat načítání dat o zpoždění
	\item Automatizovat načítání informací o zastávkách
	\item Načítat polohu vozů
	\item Zpřístupnit informace o zpoždění
\end{itemize}
