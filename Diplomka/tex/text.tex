...
Napojení nového zdroje informací o zpoždění (SŽDC). Napojení nového zdroje informací o zastávkách a stanicích (SŽDC). Vytvořit webové rozhraní pro distribuci infomací o zpoždění.
...
\n{4}{Tvorba service} (inteface, implementace) -> Tady je největší zajímavost a to využiti funkcionálního inteface z Java8~\cite{java8}
