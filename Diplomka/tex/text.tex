...
\obr{Vizualizace API (getTrainPosition)}{fig:szdc-models}{1.0}{graphics/szdc-position-models.jpg}

TODO: z tohodle vytáhni dva obrázky na input + output
\obr{Vizualizace API (getTrainPosition)}{fig:szdc-position}{1.0}{graphics/szdc-position.jpg}

TODO:
\obr{Vizualizace API (SZDC tabule)}{fig:szdc-table}{0.5}{graphics/szdc-table-global.jpg}
